...
namespace DigitalHub\Juno\Model\Ui\Boleto;
...
{
    const CODE = 'digitalhub_juno_boleto';
    ...
    public function getConfig()
    {
        ...
        $config = (bool)$this->_junoHelper->getConfigData('digitalhub_juno_boleto', 'active', $this->storeId);
        return [
            'payment' => [
                'digitalhub_juno_boleto' => [
